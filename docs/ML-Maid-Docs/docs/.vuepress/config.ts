...
export default defineUserConfig({
  ...
  locales: {
    '/': {
      title: 'ML-Maid',
      lang: 'en-US',
      description: 'User and developer documentation for ML-Maid',
    },
    '/zh/': {
      title: 'ML-Maid',
      lang: 'zh-CN',
      description: 'ML-Maid 用户与开发者文档',
    },
  },

  head: [
    // 配置站点图标
    ['link', { rel: 'icon', type: 'image/png', href: 'https://raw.githubusercontent.com/Kurosu-Ti01/ML-Maid/main/public/default/ML-Maid-Icon-W.png' }],
  ],
  ...
  theme: plumeTheme({
    ...
    hostname: 'https://ml-maid.kurosu.qzz.io/',

    /* 文档仓库配置，用于 editLink */
    docsRepo: 'https://github.com/Kurosu-Ti01/ML-Maid',
    docsDir: 'docs/ML-Maid-Docs/docs',
    docsBranch: 'main',
    ...
    markdown: {
      mermaid: true,
      image: { figure: true, lazyload: true },
    },
