...
const userSidebar = ['', 'getting-started', 'library', 'launching', 'plugins', 'statistics-settings']
const developerSidebar = ['', 'architecture', 'frontend', 'backend', 'plugin-system', 'plugin-development', 'storage-release', 'api-maintenance']

/* =================== locale: en-US ======================= */

const enUserGuide = defineCollection({ type: 'doc', dir: 'user-guide', linkPrefix: '/user-guide', title: 'User Guide', sidebar: userSidebar })
const enDeveloperGuide = defineCollection({ type: 'doc', dir: 'developer-guide', linkPrefix: '/developer-guide', title: 'Developer Guide', sidebar: developerSidebar })

export const enCollections = defineCollections([enUserGuide, enDeveloperGuide])

/* =================== locale: zh-CN ======================= */

const zhUserGuide = defineCollection({ type: 'doc', dir: 'user-guide', linkPrefix: '/user-guide', title: '用户文档', sidebar: userSidebar })
const zhDeveloperGuide = defineCollection({ type: 'doc', dir: 'developer-guide', linkPrefix: '/developer-guide', title: '开发者文档', sidebar: developerSidebar })

export const zhCollections = defineCollections([zhUserGuide, zhDeveloperGuide])
